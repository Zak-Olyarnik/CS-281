...
:
  ...
  ghdl -a     or_2.vhd
  ghdl -a    xor_2.vhd
  ghdl -a    half_adder_structural.vhd
  ghdl -a    full_adder_structural.vhd
  ghdl -a tb_full_adder_structural.vhd
  ghdl -e    and_2
  ghdl -e     or_2
  ghdl -e    xor_2
  ghdl -e    half_adder
  ghdl -e    full_adder
  ghdl -e tb_full_adder_s
  ghdl -r tb_full_adder_s --stop-time=200ns --disp-time --vcd=tb_full_adder_s.vcd
  gtkwave tb_full_adder_s.vcd
